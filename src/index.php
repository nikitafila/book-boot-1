...
<head>
  ...
  <title>Сајт за Обложувалници и онлајн обложување</title>
  ...
  <section id="authors" class="my-5 text-center">
    <div class="container">
      <div class="row">
        <div class="col">
          <div class="my-5">
            <h1 class="text-primary h2 pb-3">
              Најдобрите обложувалници за Македонија
            </h1>
            <p class="lead pb-3">
              Сите понуди за македонскиот пазар. Само проверени обложувалници. 
            </p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3 col-sm-6 mb-5">
          <div class="card">
            <div class="card-body">
              <img src="/img/bet365.png" alt="" class="img-fluid rounded-circle w-50 mb-3">
              <h3>Bet365</h3>
              ...
              <ul class="book-list">
                <li>Бонус 6.000 денари</li>
                <li>Плаќање со картица</li>
                <li>Кешаут</li>
                <li>Онлајн спорт</li>
              </ul>
        ...
        <div class="col-lg-3 col-sm-6 mb-5">
          <div class="card">
            <div class="card-body">
              <img src="/img/10bet.png" alt="" class="img-fluid rounded-circle w-50 mb-3">
              <h3>10bet</h3>
        ...
        <div class="col-lg-3 col-sm-6 mb-5">
          <div class="card">
            <div class="card-body">
              <img src="/img/marafonbet.png" alt="" class="img-fluid rounded-circle w-50 mb-3">
              <h3>Marathon</h3>
        ...
        <div class="col-lg-3 col-sm-6 mb-5">
          <div class="card">
            <div class="card-body">
              <img src="/img/slbet.png" alt="" class="img-fluid rounded-circle w-50 mb-3">
              <h3>Slbet</h3>
              <h6 class="text-warning"><i class="fa fa-star fa-xs"></i><i class="fa fa-star fa-xs"></i><i class="fa fa-star fa-xs"></i><i class="fa fa-star fa-xs"></i><i class="fa fa-star fa-xs"></i></h6>
              <ul class="book-list">
                <li>Бонус 100 евро</li>
    ...
    <div class="container">
      <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-text">
                  <p>Тимот на <b>dobiten.mk</b> е составен од многу професионалци со богато искуство во онлајн обложувањето на спортски настани.</p>
